...
class PageListaArtigos:
    ...
    def artigo_longo_2013(self, driver, id_artigo):
        return driver.find_element_by_xpath(
            "/html/body/div[3]/div/div/div/div[4]/div/table/tbody/tr[" + id_artigo + "]/td/a")
    
    def artigo_curto_2013(self, driver, id_artigo):
        return driver.find_element_by_xpath(
            "/html/body/div[3]/div/div/div/div[6]/div/table/tbody/tr[" + id_artigo + "]/td/a")
    
    def artigo_longo_2014(self, driver, id_artigo):
        return driver.find_element_by_xpath(
            "/html/body/div[3]/div/div/div/div[3]/div/table/tbody/tr[" + id_artigo + "]/td/a")
    ...
    def pdf_artigo_longo_2019(self, driver, id_artigo):
        return driver.find_element_by_xpath(
            "//*[@id='pkp_content_main']/div/div/div[2]/div[2]/div[2]/ul/li[" + id_artigo + "]/div/ul/li/a")

    def pdf_artigo_curto_2019(self, driver, id_artigo):
        return driver.find_element_by_xpath(
            "//*[@id='pkp_content_main']/div/div/div[2]/div[2]/div[3]/ul/li[" + id_artigo + "]/div/ul/li/a")

    def artigo_longo_2019(self, driver, id_artigo):
        return driver.find_element_by_xpath(
            "//*[@id='pkp_content_main']/div/div/div[2]/div[2]/div[2]/ul/li[" + id_artigo + "]/div/div[1]/a")

    def artigo_curto_2019(self, driver, id_artigo):
        return driver.find_element_by_xpath(
           "//*[@id='pkp_content_main']/div/div/div[2]/div[2]/div[3]/ul/li[" + id_artigo + "]/div/div[1]/a")
    ...
    def chaveamento_artigo(self, driver, ano_edicao, tipo_artigo, id):
        if ano_edicao == 2011:
            ...
            lista_elementos = []
            if tipo_artigo.lower() == "longo":
                lista_elementos.append(self.pdf_artigo_longo_2019(driver, id))
                lista_elementos.append(self.artigo_longo_2019(driver, id))
                return lista_elementos
            elif tipo_artigo.lower() == "curto":
                lista_elementos.append(self.pdf_artigo_curto_2019(driver, id))
                lista_elementos.append(self.artigo_curto_2019(driver, id))
                return lista_elementos
